      ...
      typography: (theme: (path: string) => string) => ({
        DEFAULT: {
          css: {
            ...
            '--tw-prose-quote-borders': theme('colors.muted / 1'),
            ...
            // Dark mode (if you need it, not specified but good to have)
            '--tw-prose-invert-body': theme('colors.foreground / 1'), // Assuming .dark class handles this
